...
public class Utility {
    ...
    public static String getPreferredLocation(Context context){
       ...
       return  prefs.getString( context.getString(R.string.location_key),context.getString(R.string.default_location));
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.location_units_key),
                context.getString(R.string.pref_location_units_metric))
                .equals(context.getString(R.string.pref_location_units_metric));
    }
