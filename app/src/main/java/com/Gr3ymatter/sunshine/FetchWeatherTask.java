...
import com.Gr3ymatter.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.location_units_key),
                mContext.getString(R.string.pref_location_units_metric));

        if (unitType.equals(mContext.getString(R.string.pref_location_units_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_location_units_metric))) {
